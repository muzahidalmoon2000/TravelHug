        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          <div>
            ...
            <div className="mt-4 flex items-center gap-3">
              <a className="px-4 py-2 rounded-xl bg-black text-white inline-flex items-center gap-2" href="#">App Store</a>
              <a className="px-4 py-2 rounded-xl bg-black text-white inline-flex items-center gap-2" href="#">Google Play</a>
            </div>
          </div>
        </div>
      </Container>
